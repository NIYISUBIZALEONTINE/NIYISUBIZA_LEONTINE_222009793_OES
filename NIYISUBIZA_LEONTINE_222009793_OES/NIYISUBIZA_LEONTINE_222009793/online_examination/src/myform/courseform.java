...
public class courseform implements ActionListener{
    ...
    JLabel teacher_lb = new JLabel("teacher");
    ...
    private void setLocationAndSize() {
        ...
        teacher_lb.setBounds(10, 90, 160, 30);
     
        id_txf.setBounds(200, 10, 180, 30);
        name_txf.setBounds(200, 50, 180, 30);
        teacher_txf.setBounds(200, 90, 180, 30);
    ...
    insert_btn.addActionListener(new ActionListener() {
    		...
    		public void actionPerformed(java.awt.event.ActionEvent e) {
    			try {
    				...
    				pStatement.setString(3, teacher_txf.getText());	
        ...
        update_btn.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(java.awt.event.ActionEvent e) {
        			try {
        				Class.forName("com.mysql.cj.jdbc.Driver");	
        				Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/online_examination","root","");
        				String sql="UPDATE course SET  user=?,course=?,WHERE id=?";
        				PreparedStatement stm=connection.prepareStatement(sql);
        				stm.setString(1, name_txf.getText());
        				stm.setString(2,teacher_txf.getText());
