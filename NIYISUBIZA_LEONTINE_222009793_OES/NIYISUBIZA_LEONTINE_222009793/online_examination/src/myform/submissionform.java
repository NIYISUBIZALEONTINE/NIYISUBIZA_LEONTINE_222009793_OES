...
public class submissionform implements ActionListener {
    ...
    JLabel submissiontime_lb = new JLabel("submissiontime");
    ...
    JTextField submission_time_txf = new JTextField();
    JTextField score_texField =new JTextField();
    ...
    private void setLocationAndSize() {
        ...
        submissiontime_lb.setBounds(10, 170, 160, 30);
        score_lb.setBounds(10, 210, 160, 30);
        ...
        submission_time_txf.setBounds(200, 170, 180, 30);
        score_texField.setBounds(200, 210, 180, 30);
    ...
    private void setFontForAll() {
        ...
        submissiontime_lb.setFont(font);
       score_lb.setFont(font);
        ...
        submission_time_txf.setFont(font);
        score_texField.setFont(font);
    ...
    private void addComponentsForFrame() {
        ...
        frame.add(exam_txf);
        frame.add(submission_time_txf);      
        frame.add(score_texField);
    ...
    insert_btn.addActionListener(new ActionListener() {
    		...
    		public void actionPerformed(java.awt.event.ActionEvent e) {
    			try {
    				...
    				pStatement.setString(5, submission_time_txf.getText());
    				pStatement.setString(6, score_texField.getText());
        ...
        update_btn.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(java.awt.event.ActionEvent e) {
        			try {
        				Class.forName("com.mysql.cj.jdbc.Driver");	
        				Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/online_examination","root","");
        				String sql="UPDATE submission SET  user=?,assignment=?,exam=?, submissiontime=?, score=?,WHERE id=?";
        				PreparedStatement stm=connection.prepareStatement(sql);
        				stm.setString(1, user_txf.getText());
        				stm.setString(2, assignment_txf.getText());
        				stm.setString(3, exam_txf.getText());
        				stm.setString(4, submission_time_txf.getText());
        				stm.setString(5, score_texField.getText());
